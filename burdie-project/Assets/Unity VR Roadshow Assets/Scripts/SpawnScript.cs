...
public class SpawnScript : MonoBehaviour
{
	...
	public float spawnInterval = 1f;	//Interval in seconds to spawn at
    public float spawnRandomness = 5f;
	...
	void Spawn()
	{
        ...
        Vector3 randomSpawnpoint = new Vector3(Random.Range(-spawnRandomness, spawnRandomness), 0, Random.Range(-spawnRandomness, spawnRandomness));
        enemyObj.transform.parent = transform;
        enemyObj.transform.position += randomSpawnpoint;
